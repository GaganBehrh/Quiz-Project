const questions = [
  {
    i: 0,
    question:
      "1/4. What is the most populous and most visited city in Switzerland?",
    answer: [
  ...
  },
  {
    i: 2,
    question:
      "3/4. What is the most populous and most visited city in Germany?",
    answer: [
  ...
  },
  {
    i: 3,
    question:
      "4/4. What is the most populous and most visited city in Austria?",
    answer: [
...
function endGame(event) {
  ...
  if (score < 4) gameOver.innerText = "Sorry,You Lost!Try again Later....:(";
  else if (score >= 4) gameOver.innerText = "Congrats!!!! you won... :)";
}
...
nextButton.addEventListener("click", () => {
  ...
  if (score > 4)
    result[0].innerText =
      "This was the last question, please click the finish button";
  begin = false;
